...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font (cond ((find-font (font-spec :name "SF Mono"))
                                    '("SF Mono" :size 10))
                                   ((find-font (font-spec :name "Menlo"))
                                    '("Menlo" :size 10))
                                   ((find-font (font-spec :name "Monospace"))
                                    '("Monospace" :size 10))
                                   (t '("Source Code Pro" :size 10)))
   ;; The leader key
...
(custom-set-faces
 ...
 '(aw-leading-char-face ((t (:foreground "red" :inherit aw-leading-char-face :height 3.0))))
